...
module.exports = bosco = async (bosco, mek) => {
	try {
       ...
       const catlo = (teks) => {
        ...
        const grupinv = (teks) => {
        	grup = bosco.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://WA.me/+919392463937', "groupName": `Bosco Family`, "footerText": "*jash*", "jpegThumbnail": dfrply, "caption": teks}}, {quoted:fvideo})
